...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/OperatorFoundation/InternetProtocols", from: "2.2.3"),
        ...
        .package(url: "https://github.com/OperatorFoundation/TransmissionAsync", from: "0.1.3"),
    ],
    targets: [
